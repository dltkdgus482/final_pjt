    ...
    <ul>
      <li>
        <Router-link class="router" :to="{ name: 'MainView' }">
          <div>
            <img width="24" height="24" src="/assets/bottomNavIcons/home.png" alt="home-img">
      ...
      <li>
        <Router-link class="router" :to="{ name: 'DepositView' }">
          <div>
            <img width="24" height="24" src="/assets/bottomNavIcons/finance.png" alt="finance-png">
      ...
      <li>
        <Router-link class="router" :to="{ name: 'ExchangeRateView' }">
          <div>
            <img width="24" height="24" src="/assets/bottomNavIcons/stock.png" alt="stock-png">
            <!-- <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
              <g id="_Group_2">
                <g id="_Group_3">
      ...
      <li>
        <Router-link class="router" :to="{ name: 'ArticleView' }">
          <div>
            <img width="24" height="24" src="/assets/bottomNavIcons/article.png" alt="article-png">
            <!-- <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
              <g id="XMLID_184_">
      ...
      <li>
        <Router-link class="router" :to="{ name: 'MapView' }">
          <div>
            <img width="24" height="24" src="/assets/bottomNavIcons/map.png" alt="map-png">
