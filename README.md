...
- CC FINANCE는  금융 정보뿐만 아니라,SSAFY생과 같은 젊은 청년들에게 친숙한 AI Chatbot을 제공하며,
새롭게 떠오르는 투자처인 가상화폐 Coin에 대한 정보를 제공하는
금융 웹 애플리케이션입니다.
...
- 손원륜
  - 이전에 경험해본 프로젝트 덕분에 초반 기획과 설계에 좀 더 신경을 썼습니다. 하지만 규모가 좀 더 커진만큼 프로젝트의 기획과 설계도 더욱 복잡하다는 걸 알았지만, 어서 빨리 작업에 들어가야겠다는 생각에 결국 컴포넌트 구조가 매우 복잡하고 불필요한 부분이 많아졌습니다. 기획과 설계를 위한 공부와 연습, 경험을 통해 앞으로는 같은 기간에 보다 더 디테일한 기획, 설계를 세워보고 싶습니다.
    
  - 생각보다 크게 잡은 계획 때문에 기능 하나하나에 디테일이 떨어지는 점이 아쉬웠습니다. 사용자의 입장에서 생각하여 사용자에게 더욱 필요한 기능을 구현하는게 다양하고 어려운 기능을 구현하는 것 보다 더 중요하다는 생각을 갖게 되었습니다.
    
  - 미뤄온 공부들을 한 번에 하는 기분이었습니다. 너무나도 부족한 역량에 완성을 할 수 있을까 하는 걱정을 팀원 덕분에 마무리할 수 있었습니다. 하지만, 프로젝트를 만들어가면서 아직 이해되지 않는 부분이 많이 남아있음을 느꼈습니다. 이번 프로젝트를 복습하고 개선하며 부족한 부분이 무엇인지 명확히 알고, 이를 보충하는 시간을 가져야함을 배웠습니다.
    
  - 주로 작업한 html구조 및 css와 Javascript 작업을 통해 프론트엔드에서의 재미를 느낄 수 있었습니다. 아직 Javascript부분에 대해서는 개념적인 부분과 프레임워크의 활용성을 키워야하고, css또한 보다 AI나 프레임워크등을 통해 효율적인 방법으로 빠른시간안에 원하는 디자인을 완성해나갈 수 있어야함을 느꼈습니다.
    
  - 2학기가 시작하기전에 적어도 한 개 이상의 사이드 프로젝트를 경험해보고 싶어졌습니다.
